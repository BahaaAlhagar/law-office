...
function nodeClient (request) {
    ...
    var client = __webpack_require__(125);
...
Component.options.__file = "resources/assets/js/components/person/editPerson.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-451f011c", Component.options)
  } else {
    hotAPI.reload("data-v-451f011c", Component.options)
  }
            ...
            _c(
              "form",
              {
                ...
                on: {
                  submit: function($event) {
                    ...
                    return _vm.onPersonUpdate($event)
                  },
              ...
              [
                ...
                _c("div", { staticClass: "form-group" }, [
                  _c(
                    "label",
                    { staticClass: "label", attrs: { for: "location" } },
                    [_vm._v("محل الاقامة:")]
                  ),
                  _vm._v(" "),
                  _c("input", {
                    ...
                    domProps: { value: _vm.editForm.location },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.$set(_vm.editForm, "location", $event.target.value)
                      }
                    }
                  }),
                  _vm._v(" "),
                  _vm.editForm.errors.has("location")
                    ? _c("span", {
                        staticClass: "alert-danger",
                        domProps: {
                          textContent: _vm._s(
                            _vm.editForm.errors.get("location")
                          )
                        }
                      })
                    : _vm._e()
                ...
                _c("div", { staticClass: "form-group" }, [
                  _c(
                    "label",
                    { staticClass: "label", attrs: { for: "idenity" } },
                    [_vm._v("الرقم القومى:")]
                  ),
                  _vm._v(" "),
                  _c("input", {
                    ...
                    staticClass: "form-control",
                    attrs: { type: "text", id: "idenity", name: "idenity" },
                    domProps: { value: _vm.editForm.idenity },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.$set(_vm.editForm, "idenity", $event.target.value)
                      }
                    }
                  }),
                  _vm._v(" "),
                  _vm.editForm.errors.has("idenity")
                    ? _c("span", {
                        staticClass: "alert-danger",
                        domProps: {
                          textContent: _vm._s(
                            _vm.editForm.errors.get("idenity")
                          )
                        }
                      })
                    : _vm._e()
                ...
                _c("div", { staticClass: "form-group" }, [
                  _c(
                    "label",
                    { staticClass: "label", attrs: { for: "is_client" } },
                    [_vm._v("الحاله:")]
                  ),
                  _vm._v(" "),
                  _c(
                    "select",
                    {
                      ...
                      staticClass: "form-control",
                      attrs: { id: "is_client", name: "is_client" },
                      on: {
                        change: function($event) {
                    ...
                    [
                      ...
                      _c("option", { attrs: { value: "0" } }, [
                        _vm._v("لــيــس مــوكــل")
                      ])
                    ]
                  ),
                  _vm._v(" "),
                  _vm.editForm.errors.has("is_client")
                    ? _c("span", {
                        staticClass: "alert-danger",
                        domProps: {
                          textContent: _vm._s(
                            _vm.editForm.errors.get("is_client")
                          )
                        }
                      })
                    : _vm._e()
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-451f011c", module.exports)
  }
}
...
var _vueResource = __webpack_require__(124);

var _vueResource2 = _interopRequireDefault(_vueResource);

var _vuejsPaginator = __webpack_require__(126);

var _vuejsPaginator2 = _interopRequireDefault(_vuejsPaginator);

var _addPerson = __webpack_require__(175);

var _addPerson2 = _interopRequireDefault(_addPerson);

var _editPerson = __webpack_require__(139);
...
Component.options.__file = "resources/assets/js/components/person/addPerson.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6d6af59a", Component.options)
  } else {
    hotAPI.reload("data-v-6d6af59a", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
            ...
            _c(
              "form",
              {
                ...
                on: {
                  submit: function($event) {
                    $event.preventDefault()
                    return _vm.onPersonCreate($event)
                  },
                  keydown: function($event) {
              ...
              [
                ...
                _c("div", { staticClass: "form-group" }, [
                  ...
                  _c("input", {
                    ...
                    staticClass: "form-control",
                    attrs: { type: "text", id: "idenity", name: "idenity" },
                    domProps: { value: _vm.form.idenity },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.$set(_vm.form, "idenity", $event.target.value)
                      }
                    }
                  }),
                  _vm._v(" "),
                  _vm.form.errors.has("idenity")
                    ? _c("span", {
                        staticClass: "alert-danger",
                        domProps: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-6d6af59a", module.exports)
  }
}
