...
var _addIssue = __webpack_require__(192);
...
Component.options.__file = "resources/assets/js/components/issue/addIssue.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-501fdc05", Component.options)
  } else {
    hotAPI.reload("data-v-501fdc05", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
              ...
              [
                ...
                _c("div", { staticClass: "form-group" }, [
                  ...
                  _c("input", {
                    ...
                    domProps: { value: _vm.form.adv_number },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.$set(_vm.form, "adv_number", $event.target.value)
                      }
                    }
                  }),
                  _vm._v(" "),
                  _vm.form.errors.has("adv_number")
                    ? _c("span", {
                        staticClass: "alert-danger",
                        domProps: {
                ...
                _c("div", { staticClass: "form-group" }, [
                  ...
                  _c("input", {
                    ...
                    staticClass: "form-control",
                    attrs: { type: "text", id: "adv_year", name: "adv_year" },
                    domProps: { value: _vm.form.adv_year },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.$set(_vm.form, "adv_year", $event.target.value)
                      }
                    }
                  }),
                  _vm._v(" "),
                  _vm.form.errors.has("adv_year")
                    ? _c("span", {
                        staticClass: "alert-danger",
                        domProps: {
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c("option", { attrs: { value: "5" } }, [
                        _vm._v("مــدنـى جــزئى")
                      ]),
                      _vm._v(" "),
                      _c("option", { attrs: { value: "6" } }, [
                        _vm._v("مــدنـى كــلـى")
                      ]),
                      _vm._v(" "),
                      _c("option", { attrs: { value: "7" } }, [
                        _vm._v("صــحــة توقيــع")
                      ]),
                      _vm._v(" "),
                ...
                _c("div", { staticClass: "form-group" }, [
                  ...
                  _c("input", {
                    ...
                    staticClass: "form-control",
                    attrs: { type: "text", id: "court", name: "court" },
                    domProps: { value: _vm.form.court },
                    on: {
                      input: function($event) {
                        if ($event.target.composing) {
                          return
                        }
                        _vm.$set(_vm.form, "court", $event.target.value)
                      }
                    }
                  }),
                  _vm._v(" "),
                  _vm.form.errors.has("court")
                    ? _c("span", {
                        staticClass: "alert-danger",
                        domProps: {
...
var staticRenderFns = [
  ...
  function() {
    ...
    var _h = _vm.$createElement
    var _c = _vm._self._c || _h
    return _c("label", { staticClass: "label", attrs: { for: "type" } }, [
      _vm._v("نوع القضية "),
      _c("span", { staticClass: "red" }, [_vm._v("(لا يمكنك تغيره فيما بعد)")]),
      _vm._v(":")
    ])
  }
]
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-501fdc05", module.exports)
  }
}
