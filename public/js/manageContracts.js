...
var update = __webpack_require__(123)("31d1cbf2", content, false, {});
...
var _addContract = __webpack_require__(185);

var _addContract2 = _interopRequireDefault(_addContract);

var _editContract = __webpack_require__(142);
...
var manageContracts = new Vue({
  ...
  components: {
    addContract: _addContract2.default,
...
Component.options.__file = "resources/assets/js/components/contract/addContract.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-f3163a26", Component.options)
  } else {
    hotAPI.reload("data-v-f3163a26", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(123)("0c70a137", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../css-loader/index.js!../../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-f3163a26\",\"scoped\":false,\"hasInlineConfig\":true}!./vue-multiselect.min.css", function() {
     var newContent = require("!!../../css-loader/index.js!../../vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-f3163a26\",\"scoped\":false,\"hasInlineConfig\":true}!./vue-multiselect.min.css");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
              ...
              _c(
                "form",
                {
                  ...
                  on: {
                    submit: function($event) {
                      $event.preventDefault()
                      return _vm.onContractCreate($event)
                    },
                    keydown: function($event) {
                ...
                [
                  ...
                  _c(
                    ...
                    [
                      ...
                      _c("multiselect", {
                        ...
                        on: {
                          input: function($event) {
                            return _vm.form.errors.clear("people")
                          }
                        },
                        model: {
                  ...
                  _c("div", { staticClass: "form-group" }, [
                    ...
                    _c("input", {
                      ...
                      domProps: { value: _vm.form.archive_number },
                      on: {
                        input: function($event) {
                          if ($event.target.composing) {
                            return
                    ...
                    _vm._v(" "),
                    _vm.form.errors.has("archive_number")
                      ? _c("span", {
                          staticClass: "alert-danger",
                          domProps: {
                            textContent: _vm._s(
                              _vm.form.errors.get("archive_number")
                            )
                          }
                        })
                      : _vm._e()
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-hot-reload-api")      .rerender("data-v-f3163a26", module.exports)
  }
}
