            ...
            <table class="table table-responsive">
              <tbody>
                <tr>
                  ...
                  <th class="brown"><strong>مرحلة التقاضى</strong></th>
                ...
                <tr v-for="judgement in data" :key="judgement.id">
                	...
                	<td>
                      <a :href="'/people/' + judgement.person.id">
                          {{ judgement.person.name }}
                      </a>
                	</td>
                	<td>
...
<script>
	...
	export default {
        ...
        level(judgement){
          let level = judgement.level;
          switch(level) {
            case 1: return "اول درجة"; break;
            case 2: return "معارضة"; break;
            case 3: return "استئناف"; break;
            case 4: return "معارضة استئنافية"; break;
          	}
          },
	      issueType(issue){
          let type = issue.type;
